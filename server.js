...
const app = express();
// FIX: Changed PORT to use environment variable for production/Render
const PORT = process.env.PORT || 5000; 

// Middleware
app.use(bodyParser.json());
app.use(bodyParser.urlencoded({ extended: true }));
// FIX: Added 1-day caching (maxAge: '1d') for static files (CSS/Logo) to fix slow loading on Render
